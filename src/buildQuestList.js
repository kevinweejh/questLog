...
export default () => {
    ...
    const questAddBtn = createElement('btn', ['p-3', 'm-3', 'border-brown-600', 'border-2', 'text-white', 'hover:bg-yellow-400', 'hover:border-yellow-400', 'hover:text-yellow-800', 'cursor-pointer', 'rounded-full', 'w-1/3', 'text-center', 'bg-yellow-800', 'z-10', 'absolute', 'top-[5%]', 'font-extrabold'], 'Add Quest');
    const questList = createElement('div', ['flex', 'flex-col', 'border-green-300', 'border-4', 'z-10', 'absolute', 'max-h-[65%]', 'overflow-y-auto', 'top-1/2', 'left-1/2', 'transform', '-translate-x-1/2', '-translate-y-1/2', 'w-1/3'], '', 'fullQuestLog');
